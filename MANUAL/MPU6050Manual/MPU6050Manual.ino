...
//                       XA      YA      ZA      XG      YG      ZG
int MPUOffsets[6] = { -505, 604, 1859,  30,  -19, -4};
...
//  Serial.println("-----------");
  if (!v1 == 0 && !v2 == 0 && !v3 == 0 && !v4 == 0)
  {
    ...
    */
    ...
    x2 =  map(v3, 1000, 2000, -70, 70);
    bias = int((origin - Yaw) * factor);
